...
def check_independence_fast(profile, winners, rule_func, n_samples=20):
    winner_set = set(winners)
    ...
    for loser in losers:
        for _ in range(n_samples):
            ...
            new_w = rule_func(MockProfile(new_rankings, profile.num_cands))
            if loser in new_w: return 0
    return 1

# --- 4. SIMULATION ---

def run_simulation(min_voters=5, max_voters=55, num_alternatives=5, trials=500):
    methods = [
    ...
    for t in range(TRIALS):
        N = random.randint(min_voters, max_voters)
...
if __name__ == "__main__":
    print("="*75)
    print("Configuration 1: 5 alternatives, 5-55 voters")
    print("="*75)
    run_simulation(min_voters=5, max_voters=55, num_alternatives=5, trials=1000)
    
    print("\n\n")
    print("="*75)
    print("Configuration 2: 7 alternatives, 7-77 voters")
    print("="*75)
    run_simulation(min_voters=7, max_voters=77, num_alternatives=7, trials=1000)